...
def main():
    ...
    parser.add_argument('--model', default='softmil', type=str, help='MIL model [dsmil]')
    ...
    milnet = softmil(input_size=args.feats_size).cuda()
    ...
    best_score = 10**(10)
    save_path = os.path.join('weights/softmil', datetime.datetime.now().strftime("%Y%m%d%H%M%S%f"))
    print(save_path)
